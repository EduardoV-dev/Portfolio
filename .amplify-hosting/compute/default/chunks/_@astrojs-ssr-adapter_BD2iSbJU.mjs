!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"51a973bd64882fbe40a2b1fa1d425937ebce5721"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="ca08d17b-d0c5-4af1-826e-02e7479e3109",e._sentryDebugIdIdentifier="sentry-dbid-ca08d17b-d0c5-4af1-826e-02e7479e3109");}catch(e){}}();import { v as ROUTE_TYPE_HEADER, w as REROUTE_DIRECTIVE_HEADER, D as DEFAULT_404_COMPONENT, A as AstroError, x as ActionNotFoundError, y as s, z as clientAddressSymbol, B as LocalsNotAnObject, C as FailedToFindPageMapSSR, G as REROUTABLE_STATUS_CODES, H as responseSentSymbol, J as nodeRequestAbortControllerCleanupSymbol, K as getDefaultExportFromCjs } from './astro/server_BQXoxoT-.mjs';
import 'clsx';
import { D as DEFAULT_404_ROUTE, d as default404Instance, e as ensure404Route } from './astro-designed-error-pages_CCxhuAVH.mjs';
import buffer from 'node:buffer';
import nodeCrypto from 'node:crypto';
import fs, { existsSync, readFileSync } from 'node:fs';
import { Http2ServerResponse } from 'node:http2';
import { f as fileExtension, j as joinPaths, s as slash, p as prependForwardSlash$1, r as removeTrailingForwardSlash, a as appendForwardSlash$1, b as isInternalPath, c as collapseDuplicateTrailingSlashes, h as hasFileExtension } from './path_DPw5qZhY.mjs';
import { m as matchPattern } from './remote_9mVyZpKS.mjs';
...
import { N as NOOP_MIDDLEWARE_FN } from './noop-middleware_Cb7mxvi1.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { sessionStore, getDriverConfig } from './session-driver_CO6sMJg1.mjs';
...
function createStaticHandler(app, options) {
    ...
    return (req, res, ssr) => {
        if (req.url) {
            ...
            stream.on('error', (err) => {
                if (forwardError) {
                    console.error('[serve-static] Stream error:', err instanceof Error ? err.stack || err.message : String(err));
                    res.writeHead(500);
                    res.end('Internal server error');
                    return;
                }
...
function createExports(manifest, options) {
    ...
    return {
        options: options,
        handler: options.mode === 'middleware'
