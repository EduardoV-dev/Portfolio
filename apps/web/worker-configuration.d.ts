/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 33bea278a44629c6e0debc418084a085)
// Runtime types generated with workerd@1.20260515.1 2026-05-17 nodejs_compat
interface __BaseEnv_Env {
	GLOBAL_RATE_LIMITER?: RateLimit;
	AI_CHAT_RATE_LIMITER?: RateLimit;
	AI_CHAT_GLOBAL_RATE_LIMITER?: RateLimit;
	ASSETS: Fetcher;
	STRAPI_CMS_OPTIONAL?: "false";
	PUBLIC_GA_MEASUREMENT_ID?: "G-CPKFK53CJE" | "G-Q8P38XLZGF";
	SENTRY_DSN: string;
	PUBLIC_SENTRY_ENABLED: string;
	...
	GITHUB_REBUILD_WORKFLOW_FILE: string;
	GITHUB_REBUILD_REF: string;
...
declare namespace Cloudflare {
	interface StagingEnv {
		...
		ASSETS: Fetcher;
		STRAPI_CMS_OPTIONAL: "false";
		PUBLIC_GA_MEASUREMENT_ID: "G-CPKFK53CJE";
		SENTRY_DSN: string;
		PUBLIC_SENTRY_ENABLED: string;
		PUBLIC_ENVIRONMENT: string;
		PUBLIC_WEB3FORMS_ACCESS_KEY: string;
	...
	interface ProductionEnv {
		...
		ASSETS: Fetcher;
		STRAPI_CMS_OPTIONAL: "false";
		PUBLIC_GA_MEASUREMENT_ID: "G-Q8P38XLZGF";
		SENTRY_DSN: string;
		PUBLIC_SENTRY_ENABLED: string;
		PUBLIC_ENVIRONMENT: string;
		PUBLIC_WEB3FORMS_ACCESS_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "STRAPI_CMS_OPTIONAL" | "PUBLIC_GA_MEASUREMENT_ID" | "SENTRY_DSN" | "PUBLIC_SENTRY_ENABLED" | "PUBLIC_ENVIRONMENT" | "PUBLIC_WEB3FORMS_ACCESS_KEY" | "SENTRY_AUTH_TOKEN" | "SENTRY_ORG" | "SENTRY_PROJECT" | "PUBLIC_SITE_URL" | "STRAPI_API_TOKEN" | "STRAPI_API_URL" | "STRAPI_WEBHOOK_SECRET" | "GITHUB_ACTIONS_TOKEN" | "GITHUB_REPO_OWNER" | "GITHUB_REPO_NAME" | "GITHUB_REBUILD_WORKFLOW_FILE" | "GITHUB_REBUILD_REF" | "AI_PROVIDER_API_KEY" | "AI_PROVIDER_BASE_URL">> {}
}
